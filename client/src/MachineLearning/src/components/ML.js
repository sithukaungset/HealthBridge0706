    ...
    return <div className={classes.root}>
        ...
        <Container className={classes.content}>
            <ExpansionPanel>
                ...
                id="panel1a-header"
                >
                <Typography className={classes.heading}>Instruction for Health Bridge AI</Typography>
                </ExpansionPanelSummary>
            ...
            <ExpansionPanel>
                ...
                id="panel2a-header"
                >
                <Typography className={classes.heading}>Machine Learning Model</Typography>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                <Typography variant="body2">
            ...
            <ExpansionPanel>
                ...
                id="panel3a-header"
                >
                <Typography className={classes.heading}>Prediction Performance</Typography>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                <Typography variant="body2">
            ...
            <ExpansionPanel>
                ...
                id="panel3a-header"
                >
                <Typography className={classes.heading}>Data Management</Typography>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                <Typography variant="body2">
            ...
            <footer className={classes.footer}>
                <Button className={classes.button} href="https://davidpfahler.com/privacy-policy/">Health Bridge (FHIR Engine)</Button>
                <Button className={classes.button} href="https://davidpfahler.com/impressum/">INLab Dongguk</Button>
            </footer>
        </Container>
  </div>;
}
